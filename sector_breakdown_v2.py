#!/usr/bin/env python3
"""
Stock Portfolio Sector Breakdown with Pie Chart (v2 - Today's Prices)
...
def main():
    ...
    console.print(Align.center(Panel.fit(
        "[bold bright_yellow]📈  SECTOR BREAKDOWN ANALYZER v2  📈[/]\n"
        "[dim]Using today's real prices[/]",
    ...
    # Save the chart
    filename = "/home/user/claude-test/sector_breakdown_chart_v2.png"
    ...
    console.print(f"[dim]⏱ Execution time: {elapsed:.2f}s[/]")
    console.print()
